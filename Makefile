...
build-dev:
	CGO_ENABLED=0 GOOS=darwin GOARCH=arm64 go build -ldflags='-X main.Version=$(VERSION)' -tags '$(DATABASE) $(SOURCE)' -o migrate.darwin-arm64 ./cmd/migrate

build:
	CGO_ENABLED=0 GOOS=darwin GOARCH=amd64 go build -ldflags='-X main.Version=$(VERSION)' -tags '$(DATABASE) $(SOURCE)' -o build/migrate.darwin-amd64 ./cmd/migrate
	CGO_ENABLED=0 GOOS=darwin GOARCH=arm64 go build -ldflags='-X main.Version=$(VERSION)' -tags '$(DATABASE) $(SOURCE)' -o build/migrate.darwin-arm64 ./cmd/migrate
	CGO_ENABLED=0 GOOS=linux GOARCH=arm64 go build -ldflags='-X main.Version=$(VERSION)' -tags '$(DATABASE) $(SOURCE)' -o build/migrate.linux-arm64 ./cmd/migrate
	CGO_ENABLED=0 GOOS=linux GOARCH=amd64 go build -ldflags='-X main.Version=$(VERSION)' -tags '$(DATABASE) $(SOURCE)' -o build/migrate.linux-amd64 ./cmd/migrate
	CGO_ENABLED=0 GOOS=windows GOARCH=386 go build -ldflags='-X main.Version=$(VERSION)' -tags '$(DATABASE) $(SOURCE)' -o build/migrate.windows-386 ./cmd/migrate
	CGO_ENABLED=0 GOOS=windows GOARCH=amd64 go build -ldflags='-X main.Version=$(VERSION)' -tags '$(DATABASE) $(SOURCE)' -o build/migrate.windows-amd64 ./cmd/migrate

build-os:	
	CGO_ENABLED=0 GOOS=linux GOARCH=amd64 go build -ldflags='-X main.Version=$(VERSION)' -tags '$(DATABASE) $(SOURCE)' ./cmd/migrate
	CGO_ENABLED=0 GOOS=linux GOARCH=arm go build -ldflags='-X main.Version=$(VERSION)' -tags '$(DATABASE) $(SOURCE)' ./cmd/migrate
	CGO_ENABLED=0 GOOS=linux GOARCH=arm64 go build -ldflags='-X main.Version=$(VERSION)' -tags '$(DATABASE) $(SOURCE)' ./cmd/migrate
	CGO_ENABLED=0 GOOS=darwin GOARCH=amd64 go build -ldflags='-X main.Version=$(VERSION)' -tags '$(DATABASE) $(SOURCE)' ./cmd/migrate
	CGO_ENABLED=0 GOOS=darwin GOARCH=arm64 go build -ldflags='-X main.Version=$(VERSION)' -tags '$(DATABASE) $(SOURCE)' ./cmd/migrate
	CGO_ENABLED=0 GOOS=windows GOARCH=386 go build -ldflags='-X main.Version=$(VERSION)' -tags '$(DATABASE) $(SOURCE)' ./cmd/migrate
	CGO_ENABLED=0 GOOS=windows GOARCH=amd64 go build -ldflags='-X main.Version=$(VERSION)' -tags '$(DATABASE) $(SOURCE)' ./cmd/migrate
